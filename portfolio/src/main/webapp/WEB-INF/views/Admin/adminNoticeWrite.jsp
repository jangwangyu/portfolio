	...
	<div id="wrap">
        ...
        <div id="container">
			<div class="x-board-write">
				<form id="write" method="post" action="/Admin/adminNoticeWritePost">
					<div class="base-table typeWrite">
						<table border="1">
							...
							<tbody>
								<tr>
									<th scope="row"> 제목</th>
		                    		<td> 
		                    			<input id="title" name="title" class="inputTypeText" maxlength="125" value="" type="text">  
		                    		</td>
		                		</tr>
		                		<tr>
									<th scope="row"> 작성자</th>
						...
						<span class="gRight">
						    <a href="#" id="adminNoticeWritePost"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/board/btn_write.gif" alt="글쓰기"></a>
...
var oEditors = [];
	...
	$(function() {
        $("#adminNoticeWritePost").click(function(e) {
